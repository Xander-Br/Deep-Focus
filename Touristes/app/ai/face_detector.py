...
def get_face_detector(modelFile=None,
    ...
    if quantized:
        if modelFile == None:
            modelFile = "../resources/models/opencv_face_detector_uint8.pb"
        if configFile == None:
            configFile = "../resources/models/opencv_face_detector.pbtxt"
        ...
        if configFile == None:
            configFile = "../resources/models/deploy.prototxt"
